 ...
 * @ORM\Entity(repositoryClass="MyApp\PIBundle\Repository\UtilisateursAdressesRepository")
 */
class UtilisateursAdresses
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="MyApp\UserBundle\Entity\User", inversedBy="adresses")
